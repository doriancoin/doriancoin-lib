...
unsigned int nStakeTargetSpacing = 150;			// 30 sec block spacing

int64 nChainStartTime = 1394487303;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight < 150)//instamining protection
	{
		nSubsidy = 1 * COIN;		
	}
	if(nHeight == 500)
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in LibertyCoin
    bool fStrictPayToScriptHash = true; // Always active in LibertyCoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Liberty is generally considered a concept of political philosophy that seeks to identify the conditions in which an individual has immunity from the arbitrary exercise of authority.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("ba1c5c4e10ba3e0ed370c0a34307fd68e2bde350632e64e370e93545e1697850"));
